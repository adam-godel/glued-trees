...
function App() {
  ...
  return (
    <>
      ...
      <p>I began working on this project as part of <a href="https://www.quantumcoalition.io">QRISE 2024</a> for <a href="https://www.classiq.io/">Classiq</a>. I was selected as a winner of QRISE and the research exchange has since ended, but I continued to work on the algorithm and my implementation has become a part of the Classiq <a href="https://github.com/Classiq/classiq-library/tree/main/algorithms/glued_trees">library</a> and <a href="https://docs.classiq.io/latest/explore/algorithms/glued_trees/glued_trees/">documentation</a>. If you would like to learn more about me, feel free to access my website at <a href="https://adamgodel.me">adamgodel.me</a>. You can also send me an email at <a href="mailto:agodel@bu.edu">agodel@bu.edu</a>.</p>
      <Intro />
