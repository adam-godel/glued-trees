...
export default function Outro() {
    return (
        <>
            ...
            <p>You now have all the information you need to understand the Glued Trees notebook, which contains the actual code for the algorithm. You can access it by clicking the button below.</p>
